...
import splab.ufcg.edu.br.coest.entities.Link;
...
public class CoestTraceLinksReader  {
	...
	public TraceLinkList read(File file, MappedArtifacts mappedArtifacts) throws Exception {
		...
		if (links != null){
			...
			for (Link link : links.getLinks()) {
				...
				String artifact = mappedArtifacts.getMapIdArtifact().get(artifactID);
				
				TraceLink traceLink = new TraceLink(requirement, "Dependency", mappedArtifacts.getType(), artifact);
