...
public class TQLTestCaseGenerator implements TLRGenerator {

	private final String TLR_ARTIFACT_TEMPLATE = "art:TestCase ( %s ) ;";


	
	private TraceLinkList extractedTraceLinkList;
	
	public TQLTestCaseGenerator(TraceLinkList extractedTraceLinkList) {
	...
	private String getArtifactDeclaration(String type, String artifact) {
		...
		return String.format(TLR_ARTIFACT_TEMPLATE, artifact);
	}
